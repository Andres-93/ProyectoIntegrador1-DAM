...
public class ModificarProyectoJD extends JDialog {
	...
	private void inicializar() {
		...
		btnModificarProJD.setRolloverIcon(
				new ImageIcon(ModificarProyectoJD.class.getResource("/images/botonModificarPulsado.png")));
		...
		btnCancelar.setRolloverIcon(
				new ImageIcon(ModificarProyectoJD.class.getResource("/images/PulsadoBotonCancelar.png")));
		...
		btnAnadirAl.setRolloverIcon(
				new ImageIcon(ModificarProyectoJD.class.getResource("/images/botonIconoA\u00F1adirPulsado.png")));
		...
		btnElimAl.setRolloverIcon(
				new ImageIcon(ModificarProyectoJD.class.getResource("/images/BotonIconoEliminarPulsado.png")));
	...
	public Proyecto getDatos() {
		...
		Proyecto pro = new Proyecto(textNombre.getText(), textUrl.getText(), (double) spinnerNota.getValue(),
				(int) spinnerAno.getValue(), (int) spinnerCurso.getValue(), comboBoxGrupo.getSelectedItem().toString());
