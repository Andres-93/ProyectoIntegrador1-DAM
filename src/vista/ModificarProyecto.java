...
public class ModificarProyecto extends JPanel {
	...
	private void inicializar() {
		...
		btnModificarPro.setRolloverIcon(new ImageIcon(ModificarProyecto.class.getResource("/images/botonModificarPulsado.png")));
		...
		btnCancelar.setRolloverIcon(new ImageIcon(ModificarProyecto.class.getResource("/images/PulsadoBotonCancelar.png")));
