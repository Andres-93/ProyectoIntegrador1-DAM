...
public class EliminarProyecto extends JPanel {
	...
	private void inicializar() {
		...
		btnEliminarPro
				.setRolloverIcon(new ImageIcon(EliminarProyecto.class.getResource("/images/botonEliminarPulsado.png")));
		...
		btnCancelar
				.setRolloverIcon(new ImageIcon(EliminarProyecto.class.getResource("/images/PulsadoBotonCancelar.png")));
