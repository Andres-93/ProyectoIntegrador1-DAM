...
public class ModificarAlumnos extends JPanel {
	...
	private void inicializar() {
		...
		btnCancelar
				.setRolloverIcon(new ImageIcon(ModificarAlumnos.class.getResource("/images/PulsadoBotonCancelar.png")));
		...
		btnModificar.setRolloverIcon(
				new ImageIcon(ModificarAlumnos.class.getResource("/images/botonModificarPulsado.png")));
		...
		btnFiltrar
				.setRolloverIcon(new ImageIcon(ModificarAlumnos.class.getResource("/images/botonFiltrarPulsado.png")));
