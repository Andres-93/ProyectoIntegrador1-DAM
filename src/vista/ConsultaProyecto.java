...
public class ConsultaProyecto extends JPanel {
	...
	private void inicializar() {
		...
		comboBoxFiltro.setModel(new DefaultComboBoxModel(new String[] { "Ver Todos", "Nombre de Proyecto", "Curso",
				"Grupo", "A\u00F1o", "Ciclo", "Nombre de Alumno", "Numero de expediente" }));
		...
		btnFiltrarPro
				.setRolloverIcon(new ImageIcon(ConsultaProyecto.class.getResource("/images/botonFiltrarPulsado.png")));
		...
		btnDetalles
				.setRolloverIcon(new ImageIcon(ConsultaProyecto.class.getResource("/images/botonDetallesPulsado.png")));
		...
		btnCancelar
				.setRolloverIcon(new ImageIcon(ConsultaProyecto.class.getResource("/images/PulsadoBotonCancelar.png")));
	...
	public String filtrar() {
		...
		if (!textFiltro.getText().equals("")) {
			if (comboBoxFiltro.getSelectedIndex() == 1) {
				...
				consulta = "Select * from proyectos,alumnos,se_realizan where se_realizan.alumno = alumnos.ID_A  and se_realizan.proyecto = proyectos.id_p and alumnos.nombre like '%"
						+ textFiltro.getText() + "%'";
			} else if (comboBoxFiltro.getSelectedIndex() == 7) {
				consulta = "Select * from proyectos,alumnos,se_realizan where se_realizan.alumno = alumnos.ID_A  and se_realizan.proyecto = proyectos.id_p and alumnos.expediente = "
						+ textFiltro.getText();
