...
public class añadirAlumnos extends JPanel {
	...
	private void inicializar() {
		...
		btnAnadir
				.setRolloverIcon(new ImageIcon(añadirAlumnos.class.getResource("/images/PulsadoBotonA\u00F1adir.png")));
		...
		lblNewLabel.setBounds(0, 0, 700, 625); // El ancho hacia abajo debe ser 625 ya que el menu empuja todo 75
												// pixeles hacia abajo.
		add(lblNewLabel);
	}
