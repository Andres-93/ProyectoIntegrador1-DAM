...
public class ModificarAlumno extends JDialog {
	...
	private void inicializar() {
		...
		btnCancelar.setRolloverIcon(new ImageIcon(ModificarAlumno.class.getResource("/images/PulsadoBotonCancelar.png")));
		...
		btnModificarJD.setRolloverIcon(new ImageIcon(ModificarAlumno.class.getResource("/images/botonModificarPulsado.png")));
